...
class Data_siswa  extends CI_Controller{
	...
	public function index()
	{
		...
		$this->load->view('templates_wakel/header');
		$this->load->view('templates_wakel/sidebar_siswa');
		$this->load->view('wakel/data_siswa', $data);
		$this->load->view('templates_wakel/footer');
	}
...
//		$jurusan		= $_POST['jurusan'];
		...
		redirect('wakel/data_siswa/index');
	} 
	...
	public function edit($nisn)
	{
		...
		$this->load->view('templates_wakel/header');
		$this->load->view('templates_wakel/sidebar_siswa');
		$this->load->view('wakel/edit_siswa', $data);
		$this->load->view('templates_wakel/footer');
	}
	...
	public function detail($nisn) 
	{
		...
		$this->load->view('templates_wakel/header');
		$this->load->view('templates_wakel/sidebar_siswa');
		$this->load->view('wakel/detail_siswa', $data);
		$this->load->view('templates_wakel/footer');
	}
	...
	public function print()
	{
		...
		$this->load->view('wakel/print_siswa', $data);
	}
	...
	public function pdf()
	{
		...
		$data['siswa'] = $this->m_siswa->tampil_data('siswa')->result();
		$this->load->view('wakel/laporan_siswa_pdf', $data);
