...
class Data_tugas  extends CI_Controller{
	...
	public function index()
	{
		...
		$this->load->view('templates_wakel/sidebar_tugas');
		$this->load->view('wakel/data_tugas', $data);
...
//		$jurusan		= $_POST['jurusan'];
		...
		redirect('wakel/data_tugas/index');
	} 
	...
	public function edit($id_tugas)
	{
		...
		$this->load->view('templates_wakel/header');
		$this->load->view('templates_wakel/sidebar_tugas');
		$this->load->view('wakel/edit_tugas', $data);
		$this->load->view('templates_wakel/footer');
	}
	...
	public function detail($id_tugas) 
	{
		...
		$this->load->view('templates_wakel/header');
		$this->load->view('templates_wakel/sidebar_tugas');
		$this->load->view('wakel/detail_tugas', $data);
		$this->load->view('templates_wakel/footer');
	}
	...
	public function print()
	{
		...
		$this->load->view('wakel/print_tugas', $data);
	}
	...
	public function pdf()
	{
		...
		$data['tugas'] = $this->m_tugas->tampil_data('tugas')->result();
		$this->load->view('wakel/laporan_tugas_pdf', $data);
