<div class="container-fluid">
	...
	<?php foreach($siswa as $siswa) : ?>
		<form method="post" action="<?php echo base_url(). 'wakel/data_siswa/update' ?>" >
			...
			<a href="<?php echo base_url('wakel/data_siswa/index') ?>" class="btn btn-sm mt-3 btn-primary">Kembali</a>
