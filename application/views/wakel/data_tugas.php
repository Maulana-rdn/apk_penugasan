 <div class="container-fluid">
      ...
      <a class="btn btn-sm btn-danger mb-3" href="<?php echo base_url('wakel/data_tugas/print') ?>" target="_blank"><i class="fa fa-print fa-sm"></i> Print </a>
       <a class="btn btn-sm btn-warning mb-3" href="<?php echo base_url('wakel/data_tugas/pdf') ?>" target="_blank"><i class="fa fa-file-pdf fa-sm"></i> Export PDF </a>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><?php echo anchor('wakel/data_tugas/detail/' .$tugas->id_tugas, '<div class="btn btn-primary btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td>
           <td><?php echo anchor('wakel/data_tugas/edit/' .$tugas->id_tugas, '<div class="btn btn-success btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
            <td onclick="javascript: return confirm('Anda Yakin Hapus?')"><?php echo anchor('wakel/data_siswa/hapus/'.$tugas->id_tugas, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>')?></td>
        </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <?php echo form_open_multipart('wakel/data_tugas/tambah_aksi'); ?>
