<div class="container-fluid">
	...
	<?php foreach($tugas as $tugas) : ?>
		<form method="post" action="<?php echo base_url(). 'wakel/data_tugas/update' ?>" >
			...
			<a href="<?php echo base_url('wakel/data_tugas/index') ?>" class="btn btn-sm mt-3 btn-primary">Kembali</a>
